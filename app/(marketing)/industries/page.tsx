      ...
      <Box bg={useColorModeValue('gray.50', 'gray.800')} py={20}>
        <Container maxW="container.xl" textAlign="center">
          <VStack spacing={6}>
            ...
            <Text color={useColorModeValue('gray.600', 'gray.300')} maxW="2xl" mx="auto">
              Contact our experts to discuss how Bevcon Zentry can optimize your industrial operations
              with our comprehensive range of doors and loading bay solutions.
            </Text>
            <HStack spacing={4}>
