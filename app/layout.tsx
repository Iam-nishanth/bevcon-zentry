  ...
  return (
    ...
    >
      <head>
        ...
        {/* Basic SEO */}
        <title>
          Bevcon Zentry - High Speed Doors, Dock Levellers, Industrial Doors &
        ...
        <meta
          property="og:title"
          content="Bevcon Zentry - High Speed Doors, Dock Levellers & Industrial Door Solutions"
        />
        <meta
          property="og:description"
          content="Leading manufacturer and supplier of high speed doors, dock levellers, and industrial loading bay solutions for warehouses and manufacturing facilities."
        />
        <meta
          property="og:image"
          content="https://bevconzentry.in/static/meta/Bevcon-Zentry Twitter Card.png"
        />
        <meta
          property="og:image:alt"
          content="Bevcon Zentry - High Speed Doors and Industrial Solutions"
        />
        ...
        <meta
          name="twitter:title"
          content="Bevcon Zentry - High Speed Doors & Dock Levellers"
        />
        <meta
          name="twitter:description"
          content="Premium industrial doors, high speed doors, dock levellers and loading bay solutions for modern warehouses."
        />
        <meta
          name="twitter:image"
          content="https://bevconzentry.in/static/meta/Bevcon-Zentry Twitter Card.png"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Leading manufacturer and supplier of high speed doors, dock levellers, and industrial loading bay solutions',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://bevconzentry.in',
              description:
                'High Speed Doors, Dock Levellers and Industrial Door Solutions',
              potentialAction: {
                '@type': 'SearchAction',
                target:
                  'https://bevconzentry.in/products/?search={search_term_string}',
